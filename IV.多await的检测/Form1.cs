...
namespace IV.多await的检测
{
    public partial class Form1 : Form
    {
        ...
        public async void SimpleMethod()
        {
            ...
            richTextBox1.Text += "SimpleMethod()-s-@" + "\r\n";
            richTextBox1.Text += Thread.CurrentThread.ManagedThreadId + "--" + DateTime.Now.ToString() + res + "\r\n";
            richTextBox1.Text += "主线程即将卡12秒-e-@" + Thread.CurrentThread.ManagedThreadId + "--" + DateTime.Now.ToString() + "\r\n";
        ...
        async Task<string> GetHere()
        {
            ...
            richTextBox1.Text += "GetHere()-end-即将暂停3秒@" + Thread.CurrentThread.ManagedThreadId + "--" + DateTime.Now.ToString() + "\r\n";
            ...
            var task2 = await Task.Run(() =>
              {
                  Thread.Sleep(3000);
                  return "第二个Await的HERE返回值线程@" + Thread.CurrentThread.ManagedThreadId + "--" + DateTime.Now.ToString();
              });

            richTextBox1.Text += "第二个Await的GetHere()-end-@" + Thread.CurrentThread.ManagedThreadId + "--" + DateTime.Now.ToString() + "\r\n";
            return task + "\r\n" + task2 + "\r\n";
