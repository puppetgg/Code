...
namespace IVAsynx
{
    ...
    class MyClass
    {
        ...
        public async void SimpleMethod()
        {
            ...
            Console.WriteLine(Thread.CurrentThread.ManagedThreadId+"--"+DateTime.Now.ToString().ToString() + GetHere());
        ...
        Task<string> GetHere()
        {
            ...
            var task = Task.Run(() =>
            {
                ...
                Thread.Sleep(1500);
                Console.WriteLine("GetHere()-newsend-@" + Thread.CurrentThread.ManagedThreadId+"--"+DateTime.Now.ToString());
