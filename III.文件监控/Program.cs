...
namespace III.文件监控
{
    class Program
    {
        static RedisMQHelper redis = new RedisMQHelper();
        ...
        static void Main(string[] args)
        {
            ...
            //Task.Run(() => TestFileSystemWatcher());
        ...
        {
            string msg = string.Format("File：{0} {1}！" + DateTime.Now.ToString(), e.FullPath, e.ChangeType);
        ...
        {
            string msg = string.Format("File：{0} renamed to\n{1}" + DateTime.Now.ToString(), e.OldFullPath, e.FullPath);
            redis.ListRightPush("popmsg", msg);
            Console.WriteLine(msg);
        }
    }
    ...
    class ConsoleWin32Helper
    {
        ...
        public static void Hidden()
        {
            ...
            ParenthWnd = FindWindow(null, "CodeDemo监控");
